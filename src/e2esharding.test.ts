...
// step on a non-zero exit (pipefail through tee), and proves all twenty engine x case runs happened (H20 portrait + sheets, H21 sub-pixel).
{
  ...
  assert.match(body, /-eq 20\n/, 'CI requires all twenty tour-scroll cases to have run');
}
